      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          ...
          */
          ...
          Eigen::Map<Eigen::VectorXd> ptsx_eigen((double*)&ptsx[0], 6);
          Eigen::Map<Eigen::VectorXd> ptsy_eigen((double*)&ptsy[0], 6);
  
		  // calculate a polynomial that fits the points (ptsx, ptsy)
